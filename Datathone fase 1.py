...
#Import data
train=pd.read_csv('/Users/albertlloveras/Data analytics - Ubiqum/Datathone/Jump2digital/train.csv')
data_test=pd.read_csv('/Users/albertlloveras/Data analytics - Ubiqum/Datathone/Jump2digital/test_X.csv',sep=';')
